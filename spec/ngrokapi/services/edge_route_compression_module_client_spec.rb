...
RSpec.describe NgrokAPI::Services::EdgeRouteCompressionModuleClient do
  let(:base_url) { 'https://api.ngrok.com' }
  let(:path) { '/edges/https/%{edge_id}/routes/%{id}/compression' }
  let(:not_found) do
  ...
  before(:each) do
    ...
    @edge_route_compression_module_client = NgrokAPI::Services::EdgeRouteCompressionModuleClient.new(client: @client)
  end
  ...
  describe "#get" do
    it "will make a get request and return an instance of NgrokAPI::Models::EndpointCompression" do
      ...
      expect(@client).to receive(:get).with(path % replacements, data: data).
        and_return(endpoint_compression_result)
      result = @edge_route_compression_module_client.get(
        edge_id: endpoint_compression_result["edge_id"],
        id: endpoint_compression_result["id"]
      )
      expect(result.class).to eq(NgrokAPI::Models::EndpointCompression)
  ...
  describe "#delete" do
    it "will make a delete request" do
      ...
      @edge_route_compression_module_client.delete(
        edge_id: api_key_result["edge_id"],
        id: api_key_result["id"]
      )
    end
  ...
  describe "#delete!" do
    ...
    it "will make a delete request and return NotFoundError if 404" do
      ...
      expect do
        ...
        result = @edge_route_compression_module_client.delete!(
          edge_id: api_key_result["edge_id"],
          id: api_key_result["id"]
        )
