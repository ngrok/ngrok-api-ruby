...
RSpec.describe NgrokAPI::Services::EndpointOIDCModuleClient do
  let(:base_url) { 'https://api.ngrok.com' }
  let(:path) { '/endpoint_configurations/%{id}/oidc' }
  let(:not_found) do
  ...
  before(:each) do
    ...
    @endpoint_oidc_module_client = NgrokAPI::Services::EndpointOIDCModuleClient.new(client: @client)
  end
  ...
  describe "#replace" do
    it "will make a put request and return an instance of NgrokAPI::Models::EndpointOIDC" do
      ...
      result = @endpoint_oidc_module_client.replace(
        id: endpoint_oidc_result["id"],
  ...
  describe "#get" do
    it "will make a get request and return an instance of NgrokAPI::Models::EndpointOIDC" do
      ...
      expect(@client).to receive(:get).with(path % replacements, data: data).
        and_return(endpoint_oidc_result)
      result = @endpoint_oidc_module_client.get(
        id: endpoint_oidc_result["id"]
      )
      expect(result.class).to eq(NgrokAPI::Models::EndpointOIDC)
      # expect(result.id).to eq(endpoint_oidc_result["id"])
  ...
  describe "#delete" do
    it "will make a delete request" do
      ...
      @endpoint_oidc_module_client.delete(
        id: api_key_result["id"]
      )
    end
  end
  ...
  describe "#delete!" do
    ...
    it "will make a delete request and return NotFoundError if 404" do
      ...
      expect do
        ...
        result = @endpoint_oidc_module_client.delete!(
          id: api_key_result["id"]
        )
