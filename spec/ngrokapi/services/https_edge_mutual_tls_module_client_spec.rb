...
RSpec.describe NgrokAPI::Services::HTTPSEdgeMutualTLSModuleClient do
  let(:base_url) { 'https://api.ngrok.com' }
  let(:path) { '/edges/https/%{id}/mutual_tls' }
  let(:not_found) do
  ...
  before(:each) do
    ...
    @https_edge_mutual_tls_module_client = NgrokAPI::Services::HTTPSEdgeMutualTLSModuleClient.new(client: @client)
  end
  ...
  describe "#get" do
    it "will make a get request and return an instance of NgrokAPI::Models::EndpointMutualTLS" do
      ...
      expect(@client).to receive(:get).with(path % replacements, data: data).
        and_return(endpoint_mutual_tls_result)
      result = @https_edge_mutual_tls_module_client.get(
        id: endpoint_mutual_tls_result["id"]
      )
      expect(result.class).to eq(NgrokAPI::Models::EndpointMutualTLS)
    end
  ...
  describe "#delete" do
    it "will make a delete request" do
      ...
      @https_edge_mutual_tls_module_client.delete(
        id: api_key_result["id"]
      )
    end
  end
  ...
  describe "#delete!" do
    ...
    it "will make a delete request and return NotFoundError if 404" do
      ...
      expect do
        ...
        result = @https_edge_mutual_tls_module_client.delete!(
          id: api_key_result["id"]
        )
