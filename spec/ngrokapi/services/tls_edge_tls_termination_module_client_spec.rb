...
RSpec.describe NgrokAPI::Services::TLSEdgeTLSTerminationModuleClient do
  let(:base_url) { 'https://api.ngrok.com' }
  let(:path) { '/edges/tls/%{id}/tls_termination' }
  let(:not_found) do
  ...
  before(:each) do
    ...
    @tls_edge_tls_termination_module_client = NgrokAPI::Services::TLSEdgeTLSTerminationModuleClient.new(client: @client)
  end
  ...
  describe "#get" do
    it "will make a get request and return an instance of NgrokAPI::Models::EndpointTLSTermination" do
      ...
      expect(@client).to receive(:get).with(path % replacements, data: data).
        and_return(endpoint_tls_termination_result)
      result = @tls_edge_tls_termination_module_client.get(
        id: endpoint_tls_termination_result["id"]
      )
      expect(result.class).to eq(NgrokAPI::Models::EndpointTLSTermination)
    end
  ...
  describe "#delete" do
    it "will make a delete request" do
      ...
      @tls_edge_tls_termination_module_client.delete(
        id: api_key_result["id"]
      )
    end
  end
  ...
  describe "#delete!" do
    ...
    it "will make a delete request and return NotFoundError if 404" do
      ...
      expect do
        ...
        result = @tls_edge_tls_termination_module_client.delete!(
          id: api_key_result["id"]
        )
