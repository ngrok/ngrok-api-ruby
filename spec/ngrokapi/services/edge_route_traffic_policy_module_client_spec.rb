...
RSpec.describe NgrokAPI::Services::EdgeRouteTrafficPolicyModuleClient do
  let(:base_url) { 'https://api.ngrok.com' }
  let(:path) { '/edges/https/%{edge_id}/routes/%{id}/traffic_policy' }
  let(:not_found) do
  ...
  before(:each) do
    ...
    @edge_route_traffic_policy_module_client = NgrokAPI::Services::EdgeRouteTrafficPolicyModuleClient.new(client: @client)
  end
  ...
  describe "#replace" do
    it "will make a put request and return an instance of NgrokAPI::Models::EndpointTrafficPolicy" do
      ...
      replacements = {
        edge_id: endpoint_traffic_policy_result["edge_id"],
      ...
      result = @edge_route_traffic_policy_module_client.replace(
        edge_id: endpoint_traffic_policy_result["edge_id"],
        id: endpoint_traffic_policy_result["id"],
  ...
  describe "#get" do
    it "will make a get request and return an instance of NgrokAPI::Models::EndpointTrafficPolicy" do
      ...
      expect(@client).to receive(:get).with(path % replacements, data: data).
        and_return(endpoint_traffic_policy_result)
      result = @edge_route_traffic_policy_module_client.get(
        edge_id: endpoint_traffic_policy_result["edge_id"],
        id: endpoint_traffic_policy_result["id"]
      )
      expect(result.class).to eq(NgrokAPI::Models::EndpointTrafficPolicy)
  ...
  describe "#delete" do
    it "will make a delete request" do
      ...
      @edge_route_traffic_policy_module_client.delete(
        edge_id: api_key_result["edge_id"],
        id: api_key_result["id"]
      )
    end
  ...
  describe "#delete!" do
    ...
    it "will make a delete request and return NotFoundError if 404" do
      ...
      expect do
        ...
        result = @edge_route_traffic_policy_module_client.delete!(
          edge_id: api_key_result["edge_id"],
          id: api_key_result["id"]
        )
