...
RSpec.describe NgrokAPI::Services::TLSEdgePolicyModuleClient do
  let(:base_url) { 'https://api.ngrok.com' }
  let(:path) { '/edges/tls/%{id}/policy' }
  let(:not_found) do
  ...
  before(:each) do
    ...
    @tls_edge_policy_module_client = NgrokAPI::Services::TLSEdgePolicyModuleClient.new(client: @client)
  end
  ...
  describe "#replace" do
    it "will make a put request and return an instance of NgrokAPI::Models::EndpointPolicy" do
      ...
      result = @tls_edge_policy_module_client.replace(
        id: endpoint_policy_result["id"],
  ...
  describe "#get" do
    it "will make a get request and return an instance of NgrokAPI::Models::EndpointPolicy" do
      ...
      expect(@client).to receive(:get).with(path % replacements, data: data).
        and_return(endpoint_policy_result)
      result = @tls_edge_policy_module_client.get(
        id: endpoint_policy_result["id"]
      )
      expect(result.class).to eq(NgrokAPI::Models::EndpointPolicy)
    end
  ...
  describe "#delete" do
    it "will make a delete request" do
      ...
      @tls_edge_policy_module_client.delete(
        id: api_key_result["id"]
      )
    end
  end
  ...
  describe "#delete!" do
    ...
    it "will make a delete request and return NotFoundError if 404" do
      ...
      expect do
        ...
        result = @tls_edge_policy_module_client.delete!(
          id: api_key_result["id"]
        )
