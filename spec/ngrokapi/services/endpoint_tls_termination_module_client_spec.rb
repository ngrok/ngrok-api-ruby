...
RSpec.describe NgrokAPI::Services::EndpointTLSTerminationModuleClient do
  let(:base_url) { 'https://api.ngrok.com' }
  let(:path) { '/endpoint_configurations/%{id}/tls_termination' }
  let(:not_found) do
  ...
  before(:each) do
    ...
    @endpoint_tls_termination_module_client = NgrokAPI::Services::EndpointTLSTerminationModuleClient.new(client: @client)
  end
  ...
  describe "#replace" do
    it "will make a put request and return an instance of NgrokAPI::Models::EndpointTLSTermination" do
      ...
      result = @endpoint_tls_termination_module_client.replace(
        id: endpoint_tls_termination_result["id"],
  ...
  describe "#get" do
    it "will make a get request and return an instance of NgrokAPI::Models::EndpointTLSTermination" do
      ...
      expect(@client).to receive(:get).with(path % replacements, data: data).
        and_return(endpoint_tls_termination_result)
      result = @endpoint_tls_termination_module_client.get(
        id: endpoint_tls_termination_result["id"]
      )
      expect(result.class).to eq(NgrokAPI::Models::EndpointTLSTermination)
      # expect(result.id).to eq(endpoint_tls_termination_result["id"])
  ...
  describe "#delete" do
    it "will make a delete request" do
      ...
      @endpoint_tls_termination_module_client.delete(
        id: api_key_result["id"]
      )
    end
  end
  ...
  describe "#delete!" do
    ...
    it "will make a delete request and return NotFoundError if 404" do
      ...
      expect do
        ...
        result = @endpoint_tls_termination_module_client.delete!(
          id: api_key_result["id"]
        )
