...
RSpec.describe NgrokAPI::Models::EndpointBackend do
  before(:each) do
    ...
    @endpoint_backend = NgrokAPI::Models::EndpointBackend.new(client: @client, result: endpoint_backend_result)
  end

  describe "#==" do
    it "is equal if the results are the same" do
      other = NgrokAPI::Models::EndpointBackend.new(client: @client, result: endpoint_backend_result)
