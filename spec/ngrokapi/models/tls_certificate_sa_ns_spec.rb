...
RSpec.describe NgrokAPI::Models::TLSCertificateSANs do
  before(:each) do
    ...
    @tls_certificate_sa_ns = NgrokAPI::Models::TLSCertificateSANs.new(client: @client, result: tls_certificate_sa_ns_result)
  end

  describe "#==" do
    it "is equal if the results are the same" do
      other = NgrokAPI::Models::TLSCertificateSANs.new(client: @client, result: tls_certificate_sa_ns_result)
