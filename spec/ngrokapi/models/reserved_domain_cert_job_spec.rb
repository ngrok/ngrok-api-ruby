...
RSpec.describe NgrokAPI::Models::ReservedDomainCertJob do
  before(:each) do
    ...
    @reserved_domain_cert_job = NgrokAPI::Models::ReservedDomainCertJob.new(client: @client, attrs: reserved_domain_cert_job_result)
  end

  describe "#==" do
    it "is equal if the results are the same" do
      other = NgrokAPI::Models::ReservedDomainCertJob.new(client: @client, attrs: reserved_domain_cert_job_result)
