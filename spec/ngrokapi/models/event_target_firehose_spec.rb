...
RSpec.describe NgrokAPI::Models::EventTargetFirehose do
  before(:each) do
    ...
    @event_target_firehose = NgrokAPI::Models::EventTargetFirehose.new(client: @client, result: event_target_firehose_result)
  end

  describe "#==" do
    it "is equal if the results are the same" do
      other = NgrokAPI::Models::EventTargetFirehose.new(client: @client, result: event_target_firehose_result)
