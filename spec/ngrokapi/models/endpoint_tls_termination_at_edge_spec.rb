...
RSpec.describe NgrokAPI::Models::EndpointTLSTerminationAtEdge do
  before(:each) do
    ...
    @endpoint_tls_termination_at_edge = NgrokAPI::Models::EndpointTLSTerminationAtEdge.new(client: @client, result: endpoint_tls_termination_at_edge_result)
  end

  describe "#==" do
    it "is equal if the results are the same" do
      other = NgrokAPI::Models::EndpointTLSTerminationAtEdge.new(client: @client, result: endpoint_tls_termination_at_edge_result)
