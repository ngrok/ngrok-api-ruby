...
RSpec.describe NgrokAPI::Models::ReservedDomainCertPolicy do
  before(:each) do
    ...
    @reserved_domain_cert_policy = NgrokAPI::Models::ReservedDomainCertPolicy.new(client: @client, result: reserved_domain_cert_policy_result)
  end

  describe "#==" do
    it "is equal if the results are the same" do
      other = NgrokAPI::Models::ReservedDomainCertPolicy.new(client: @client, result: reserved_domain_cert_policy_result)
