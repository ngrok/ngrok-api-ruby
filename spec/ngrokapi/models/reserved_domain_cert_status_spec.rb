...
RSpec.describe NgrokAPI::Models::ReservedDomainCertStatus do
  before(:each) do
    ...
    @reserved_domain_cert_status = NgrokAPI::Models::ReservedDomainCertStatus.new(client: @client, attrs: reserved_domain_cert_status_result)
  end

  describe "#==" do
    it "is equal if the results are the same" do
      other = NgrokAPI::Models::ReservedDomainCertStatus.new(client: @client, attrs: reserved_domain_cert_status_result)
