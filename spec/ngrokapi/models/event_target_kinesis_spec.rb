...
RSpec.describe NgrokAPI::Models::EventTargetKinesis do
  before(:each) do
    ...
    @event_target_kinesis = NgrokAPI::Models::EventTargetKinesis.new(client: @client, result: event_target_kinesis_result)
  end

  describe "#==" do
    it "is equal if the results are the same" do
      other = NgrokAPI::Models::EventTargetKinesis.new(client: @client, result: event_target_kinesis_result)
